defmodule SymphonyElixir.StatusDashboard do
  ...
  alias SymphonyElixir.StatusDashboard.AgentMessageHumanizer
  ...
  dashboard. Delegates to `AgentMessageHumanizer`.
  """
  @spec humanize_agent_message(term()) :: String.t()
  defdelegate humanize_agent_message(message), to: AgentMessageHumanizer

  defp summarize_message(message), do: AgentMessageHumanizer.humanize_agent_message(message)
