defmodule Core.LogFile do
  ...
  @spec configure() :: :ok
  def configure do
    log_file = Utils.Runtime.get(:log_file, default_log_file())
    max_bytes = Utils.Runtime.get(:log_file_max_bytes, @default_max_bytes)
    max_files = Utils.Runtime.get(:log_file_max_files, @default_max_files)
