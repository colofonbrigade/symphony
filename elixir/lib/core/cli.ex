defmodule Core.CLI do
  ...
  defp runtime_deps do
    %{
      ...
      ensure_all_started: fn -> Application.ensure_all_started(:core) end
    }
  end
  ...
  defp set_logs_root(logs_root) do
    Application.put_env(:core, :log_file, LogFile.default_log_file(logs_root))
    :ok
  end
  ...
  defp set_server_port_override(port) when is_integer(port) and port >= 0 do
    Application.put_env(:core, :server_port_override, port)
    :ok
  end
