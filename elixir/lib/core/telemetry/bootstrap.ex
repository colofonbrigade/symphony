defmodule Core.Telemetry.Bootstrap do
  @moduledoc """
  ...
  @spec prepare() :: :ok
  def prepare do
    db_path = Application.get_env(:core, Repo, [])[:database]
  ...
  @spec migrate() :: :ok
  def migrate do
    migrations_path = Path.join([:code.priv_dir(:core), "telemetry_repo", "migrations"])
