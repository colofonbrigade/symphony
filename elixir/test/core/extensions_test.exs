defmodule Core.ExtensionsTest do
  ...
  setup do
    linear_client_module = Application.get_env(:core, :linear_client_module)

    on_exit(fn ->
      if is_nil(linear_client_module) do
        Application.delete_env(:core, :linear_client_module)
      else
        Application.put_env(:core, :linear_client_module, linear_client_module)
      end
    end)
  ...
  setup do
    endpoint_config = Application.get_env(:core, Web.Endpoint, [])
